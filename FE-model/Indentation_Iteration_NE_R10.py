...
import os.path
#os.chdir(r"C:\Temp")
project_path=r"C:\Users\jli16\Downloads\From_habibeh\Identation_test\R10_Indentation_AI"
...
rbrs = 10   #Large radius divided by the smaller radius of the indenter
            ...
            for v23 in [v23_t]:
                ...
                for G12 in [G12_t]:
                    if (E1 > E2) and (E1 < 100 * E2):
                        ...
                        if not (os.path.isfile(fname)):# and (E1/G12 <100):
                            Jobname = "Job_X10_" + str(counter)
                            #............................Material
