...
import os.path
#os.chdir(r"C:\Temp")
project_path=r"C:\Users\jli16\Downloads\From_habibeh\Identation_test\R7_Indentation_AI"
...
rbrs = 7   #Large radius divided by the smaller radius of the indenter
