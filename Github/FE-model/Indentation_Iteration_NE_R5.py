...
import os.path
#os.chdir(r"C:\Temp")
project_path=r"C:\Users\jli16\Downloads\From_habibeh\Identation_test\R5_Indentation_AI"
...
rbrs = 5   #Large radius divided by the smaller radius of the indenter
